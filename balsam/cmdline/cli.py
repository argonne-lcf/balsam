...
def make_parser():
    ...
    parser_job.add_argument(
        "--post_handle_error",
        action="store_true",
        help="Flag enables job runtime error handling by " "postprocess script",
    )
    parser_job.add_argument(
        "--post_handle_timeout",
        action="store_true",
        help="Flag enables job timeout handling by " "postprocess script",
    )
    parser_job.add_argument(
    ...
    parser_job.add_argument(
        ...
        required=False,
        default=["*"],
        help="Dataflow: filename patterns "
    ...
    parser_job.add_argument(
        "--yes",
        help="Skip prompt confirming job details.",
        required=False,
        action="store_true",
    )
    # --------------------------------------------------------------------
    ...
    parser_rm.add_argument(
        "objects",
        choices=["jobs", "apps"],
        help="permanently delete jobs or apps from DB",
    )
    ...
    parser_mkchild.add_argument("--num-nodes", type=int, required=True)
    parser_mkchild.add_argument("--ranks-per-node", type=int, required=True)

    parser_mkchild.add_argument("--description", required=False, nargs="*", default=[])
