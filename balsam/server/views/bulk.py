...
class BulkDestroyModelMixin(DestroyModelMixin):
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        msg = ( "It's dangerous to delete all items. "
...
class ListBulkCreateAPIView(ListModelMixin,
...
class ListBulkUpdateAPIView(ListModelMixin,
...
class ListBulkCreateBulkUpdateAPIView(ListModelMixin,
                                  BulkCreateModelMixin,
                                  BulkUpdateModelMixin,
                                  GenericAPIView):
    """
...
class ListBulkCreateBulkUpdateBulkDestroyAPIView(ListModelMixin,
                                         BulkCreateModelMixin,
                                         BulkUpdateModelMixin,
...
class ListSingleCreateBulkUpdateAPIView(ListModelMixin,
                                        CreateModelMixin,
                                        BulkUpdateModelMixin,
                                        GenericAPIView):
    """
