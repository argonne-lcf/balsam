...
class Scheduler:
    def __init__(self, psij_cls):
        self.scheduler = psij_cls()
...
class PBSScheduler(Scheduler):
    def __init__(self):
        super().__init__(psij.executors.PBSProJobScheduler)

class CobaltScheduler(Scheduler):
    def __init__(self):
        super().__init__(psij.executors.CobaltJobScheduler)

class SlurmScheduler (Scheduler):
    def __init__(self):
        super().__init__(psij.executors.SlurmJobScheduler)

class LocalProcessScheduler(Scheduler):
    def __init__(self):
        super().__init__(psij.executors.LocalJobScheduler)
